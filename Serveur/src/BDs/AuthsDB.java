...
public class AuthsDB {
    ...
    public static boolean uploadImage(String key, InputStream inputStream) throws SQLException {
        String query = "REPLACE INTO ProfileImages (id_user,picture) values (?, ?)";
        int user_id = getUserIdFromKey(key);
    ...
    public static Blob retreiveImage(int idUser) throws SQLException {
        String query = "select * from ProfileImages  where id_user=?";
        try (Connection conn = Database.getMySQLConnection();
             PreparedStatement preparedStmt = conn.prepareStatement(query)) {
            preparedStmt.setInt(1, idUser);
    ...
    public static JSONObject getUserInfosFromLogin(String login) throws SQLException, JSONException {
        ...
        String query = " select * From Users u , UserInfos i where (u.Username=? or u.Mail=?) && u.id_user=i.id_user ";
    ...
    public static boolean recoverPassword(String email) throws SQLException {
        ...
        try (Connection conn = Database.getMySQLConnection();
            ...
            if (preparedStmt.executeUpdate() > 0) {
                ...
                final String emailPass = "twistertest";
